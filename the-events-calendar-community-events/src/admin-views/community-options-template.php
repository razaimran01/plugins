...
$rewrite_fields = [
	...
	'current_urls' => [
		...
		'html'            => sprintf(
			...
			<p><input type="checkbox" class="tribe-accordion" id="events-community-rewite-slugs-toggle">
			<label for="events-community-rewite-slugs-toggle">%17$s</label></p>
			',
			...
			esc_html__( 'Edit URLs (slugs)', 'tribe-events-community' )
		),
		'size'            => 'medium',
		'validation_type' => 'html',
	],
	'community-rewrite-slug-settings-start' => [
		'html' => '<div id="tribe-events-community-tickets-rewite-slug-settings" class="tribe-dependent" data-depends="#events-community-rewite-slugs-toggle" data-condition-is-checked>',
	],
	...
	'community-rewrite-slug-settings-end'   => [
		'html' => '</div>',
	],
];
...
foreach ( $rewrite_fields as $name => $setting ) {
	...
	$additional_attributes = [
		'data-depends'              => '#events-community-rewite-slugs-toggle',
		'data-condition-is-checked' => '',
	];

	$setting['fieldset_attributes'] = array_merge( $existing_field_attributes, $additional_attributes );

	$setting['validate_if'] = new Tribe__Field_Conditional( 'events-community-rewite-slugs-toggle', 'tribe_is_truthy' );
